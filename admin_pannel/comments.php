                ...
                <div class="box">
                    ...
                    <div class="ratings">
                        <?php if($fetch_reviews['rating'] == 1) { ?>
                            <p style="background: red;"><i class="bx bxs-star"></i>
                                <span><?= $fetch_reviews['rating']; ?></span>
                            </p>
                        <?php } ?>
                        ...
                        <?php if($fetch_reviews['rating'] == 3) { ?>
                            <p style="background: orange;"><i class="bx bxs-star"></i>
                                <span><?= $fetch_reviews['rating']; ?></span>
                            </p>
                        <?php } ?>
                        ...
                        <?php if($fetch_reviews['rating'] == 5) { ?>
                            <p style="box-shadow: var(--inner-box-shadow);"><i class="bx bxs-star"></i>
                                <span><?= $fetch_reviews['rating']; ?></span>
                            </p>
                        <?php } ?>
                    </div>
                    ...
                    <form action="" method="post">
                        ...
                        <input type="submit" name="delete_review" value="delete review" class="btn" 
