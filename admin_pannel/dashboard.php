        ...
        <section class="dashboard">
            ...
            <div class="box-container">
                ...
                <div class="box">
                    ...
                    <a href="view_posts.php?status=active" class="btn">see products</a>
                </div>
                ...
                <div class="box">
                    ...
                    <a href="view_posts.php?status=deactive" class="btn">see products</a>
                </div>
                ...
                <div class="box">
                    ...
                    <h3><?= $number_of_post; ?></h3>
                    <p>total products</p>
                    <a href="view_posts.php" class="btn">see all products</a>
                </div>
                ...
                <div class="box">
                    ...
                    <p>total orders</p>
                    <a href="admin_order.php" class="btn">all order</a>
                </div>
